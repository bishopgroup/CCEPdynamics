...
%% Maps the confined configuration to a periodic domain in all direction with electrode separation 2*L3
    ...
    ParticlePositions(1:Particle.nParticle,3) = Parameter.electrodeDistance + ParticlePositions(1:Particle.nParticle,3);
    ParticlePositions(1+Particle.nParticle:end,3) = Parameter.electrodeDistance - ParticlePositions(1+Particle.nParticle:end,3);
