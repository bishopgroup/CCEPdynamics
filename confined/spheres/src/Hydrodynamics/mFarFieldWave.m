...
for i = 1:nGrid
    for j = 1:nGrid
        for k = 1:nGrid
            ...
            % distribute dipoles
            gridForceX(idx(:,1)) = gridForceX(idx(:,1)) ...
                + Particle.farFieldDipole(:,1,1) .* (w1(:,1,i) .* w0(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,2,1) .* (w0(:,1,i) .* w1(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,3,1) .* (w0(:,1,i) .* w0(:,2,j) .* w1(:,3,k));
            gridForceY(idx(:,2)) = gridForceY(idx(:,2)) ...
                + Particle.farFieldDipole(:,1,2) .* (w1(:,1,i) .* w0(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,2,2) .* (w0(:,1,i) .* w1(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,3,2) .* (w0(:,1,i) .* w0(:,2,j) .* w1(:,3,k));
            gridForceZ(idx(:,3)) = gridForceZ(idx(:,3)) ...
                + Particle.farFieldDipole(:,1,3) .* (w1(:,1,i) .* w0(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,2,3) .* (w0(:,1,i) .* w1(:,2,j) .* w0(:,3,k)) ...
                + Particle.farFieldDipole(:,3,3) .* (w0(:,1,i) .* w0(:,2,j) .* w1(:,3,k));
            ...
            % distribute octuples
            gridForceX(idx(:,1)) = gridForceX(idx(:,1)) ...
                + (3/5) * Particle.farFieldDipole(:,1,1) .* (w3(:,1,i) .* w0(:,2,j) .* w0(:,3,k) ...
                + w1(:,1,i) .* w2(:,2,j) .* w0(:,3,k) + w1(:,1,i) .* w0(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,2,1) .* (w2(:,1,i) .* w1(:,2,j) .* w0(:,3,k) ...
                + w0(:,1,i) .* w3(:,2,j) .* w0(:,3,k) + w0(:,1,i) .* w1(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,3,1) .* (w2(:,1,i) .* w0(:,2,j) .* w1(:,3,k) ...
                + w0(:,1,i) .* w2(:,2,j) .* w1(:,3,k) + w0(:,1,i) .* w0(:,2,j) .* w3(:,3,k));
            gridForceY(idx(:,2)) = gridForceY(idx(:,2)) ...
                + (3/5) * Particle.farFieldDipole(:,1,2) .* (w3(:,1,i) .* w0(:,2,j) .* w0(:,3,k) ...
                + w1(:,1,i) .* w2(:,2,j) .* w0(:,3,k) + w1(:,1,i) .* w0(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,2,2) .* (w2(:,1,i) .* w1(:,2,j) .* w0(:,3,k) ...
                + w0(:,1,i) .* w3(:,2,j) .* w0(:,3,k) + w0(:,1,i) .* w1(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,3,2) .* (w2(:,1,i) .* w0(:,2,j) .* w1(:,3,k) ...
                + w0(:,1,i) .* w2(:,2,j) .* w1(:,3,k) + w0(:,1,i) .* w0(:,2,j) .* w3(:,3,k));
            gridForceZ(idx(:,3)) = gridForceZ(idx(:,3)) ...
                + (3/5) * Particle.farFieldDipole(:,1,3) .* (w3(:,1,i) .* w0(:,2,j) .* w0(:,3,k) ...
                + w1(:,1,i) .* w2(:,2,j) .* w0(:,3,k) + w1(:,1,i) .* w0(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,2,3) .* (w2(:,1,i) .* w1(:,2,j) .* w0(:,3,k) ...
                + w0(:,1,i) .* w3(:,2,j) .* w0(:,3,k) + w0(:,1,i) .* w1(:,2,j) .* w2(:,3,k)) ...
                + (3/5) * Particle.farFieldDipole(:,3,3) .* (w2(:,1,i) .* w0(:,2,j) .* w1(:,3,k) ...
                + w0(:,1,i) .* w2(:,2,j) .* w1(:,3,k) + w0(:,1,i) .* w0(:,2,j) .* w3(:,3,k));
        end
    end
end
...
% errorDipole = max(max(max(abs(Particle.farFieldDipole - dipole))))
